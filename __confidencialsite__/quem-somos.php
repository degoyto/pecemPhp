...
<html>
    <head>
        ...
        <title>Quem Somos - Jornal Porto do Pecém </title>
        <link type="text/css" rel="stylesheet" href="css/geral/cabecalho.css"/>
        <link type="text/css" rel="stylesheet" href="css/quemSomos/quemSomos.css"/>
    ...
    <body>
        ...
        <?php include("componente/quemSomos/quemSomos.php")?>
