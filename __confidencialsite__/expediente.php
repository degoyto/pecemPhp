...
<html>
    <head>
        ...
        <title>Expediente - Jornal Porto do Pecém </title>
        <link type="text/css" rel="stylesheet" href="css/geral/cabecalho.css"/>
        <link type="text/css" rel="stylesheet" href="css/expediente/expediente.css"/>
    ...
    <body>
        ...
        <?php include("componente/expediente/expediente.php")?>
